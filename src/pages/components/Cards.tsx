...
const CardsPage = () => {
  ...
  <CardImage>
    <img src={ASSETS.landscape1} alt="Description" className="w-full h-auto object-contain" />
  </CardImage>
  <CardHeader>
